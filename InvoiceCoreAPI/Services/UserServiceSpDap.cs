...
public class UserServiceSpDap : IUsersService
{
    ...
    public UserServiceSpDap(IUsersRepository repository)
    {
    ...
    public async Task<ApiResponse<UsersDto>> GetByIdAsync(int id)
    {
    ...
    public async Task<ApiResponse<UsersDto>> AddAsync(UsersCreateDto dto)
    {
